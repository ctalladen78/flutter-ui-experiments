...
class WebView {
  ...
  WebView(String _url){
    _view = new WebviewScaffold( url: _url,
                              appBar: new AppBar(
                                title: const Text('Widget webview dynamic'),
                              ),
                              // withZoom: true,
  ...
  WebviewScaffold get view => _view;
...
class _MyHomePageState extends State<WebViewScreen> {
  ...
  final _urlCtrl = new TextEditingController();
      ...
      body: new Column(
        ...
        children: [
          ...
          new RaisedButton(
            ...
            child: const Text('Open with useragent'),
          ),
          // new RaisedButton(
          //   onPressed: () {
          ...
          new RaisedButton(
            ...
            child: const Text('Open widget webview youtube'),
          ),
          new RaisedButton(
            onPressed: () {
              // Navigator.of(context).pushNamed('/widget');
              Navigator.push(context, new MaterialPageRoute(
                builder : (context) => new WebView(_urlCtrl.text).view
              ));
            },
            child: const Text('Open widget webview dynamic'),
          ),
          // new Container(
          //   padding: const EdgeInsets.all(24.0),
